...
class ProductosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create producto" do
    assert_difference("Producto.count") do
      post productos_url, params: { producto: { foto: @producto.foto, precio: @producto.precio, titulo: @producto.titulo } }
    end
  ...
  test "should update producto" do
    patch producto_url(@producto), params: { producto: { foto: @producto.foto, precio: @producto.precio, titulo: @producto.titulo } }
