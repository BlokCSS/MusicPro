...
class InstrumentosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create instrumento" do
    assert_difference("Instrumento.count") do
      post instrumentos_url, params: { instrumento: { foto: @instrumento.foto, nombre: @instrumento.nombre, precio: @instrumento.precio } }
    end
  ...
  test "should update instrumento" do
    patch instrumento_url(@instrumento), params: { instrumento: { foto: @instrumento.foto, nombre: @instrumento.nombre, precio: @instrumento.precio } }
