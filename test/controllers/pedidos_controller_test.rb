...
class PedidosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pedido" do
    assert_difference("Pedido.count") do
      post pedidos_url, params: { pedido: { direccion: @pedido.direccion, instrumento: @pedido.instrumento, nombre: @pedido.nombre } }
    end
  ...
  test "should update pedido" do
    patch pedido_url(@pedido), params: { pedido: { direccion: @pedido.direccion, instrumento: @pedido.instrumento, nombre: @pedido.nombre } }
