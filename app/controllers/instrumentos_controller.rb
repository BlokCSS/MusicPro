class InstrumentosController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @instrumento.save
        format.html { redirect_to instrumento_url(@instrumento), notice: "El instrumento fue agregado con exito!" }
  ...
  def update
    respond_to do |format|
      if @instrumento.update(instrumento_params)
        format.html { redirect_to instrumento_url(@instrumento), notice: "El instrumento se actualizo exitosamente" }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to instrumentos_url, notice: "Instrumento eliminado" }
  ...
  private
    ...
    def instrumento_params
      params.require(:instrumento).permit(:nombre, :tipo, :marca, :precio)
    end
end
